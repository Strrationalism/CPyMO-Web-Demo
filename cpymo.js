...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'cpymo.data';
      var REMOTE_PACKAGE_BASE = 'cpymo.data';
...
Module['FS_createPath']("/test", "bg", true, true);
Module['FS_createPath']("/test", "bgm", true, true);
Module['FS_createPath']("/test", "chara", true, true);
Module['FS_createPath']("/test", "save", true, true);
Module['FS_createPath']("/test", "script", true, true);
Module['FS_createPath']("/test", "se", true, true);
Module['FS_createPath']("/test", "system", true, true);
Module['FS_createPath']("/test", "voice", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_cpymo.data');

      };
      Module['addRunDependency']('datafile_cpymo.data');
    ...
    loadPackage({"files": [{"filename": "/test/gameconfig.txt", "start": 0, "end": 450}, {"filename": "/test/icon.png", "start": 450, "end": 11917}, {"filename": "/test/bg/BG001_H.jpg", "start": 11917, "end": 158515}, {"filename": "/test/bg/BG018_H.jpg", "start": 158515, "end": 287700}, {"filename": "/test/bg/BG_BLACK.jpg", "start": 287700, "end": 313671}, {"filename": "/test/bg/logo1.jpg", "start": 313671, "end": 362990}, {"filename": "/test/bg/logo2.jpg", "start": 362990, "end": 420241}, {"filename": "/test/bgm/BGM00.mp3", "start": 420241, "end": 1457425, "audio": 1}, {"filename": "/test/chara/AY03BA.png", "start": 1457425, "end": 1672311}, {"filename": "/test/chara/AY04BA.png", "start": 1672311, "end": 1897233}, {"filename": "/test/save/config.csav", "start": 1897233, "end": 1897243}, {"filename": "/test/save/global.csav", "start": 1897243, "end": 1897252}, {"filename": "/test/save/save-00.csav", "start": 1897252, "end": 1897402}, {"filename": "/test/script/start.txt", "start": 1897402, "end": 1898576}, {"filename": "/test/se/SE02.wav", "start": 1898576, "end": 2322044, "audio": 1}, {"filename": "/test/system/button.png", "start": 2322044, "end": 2363969}, {"filename": "/test/system/default.ttf", "start": 2363969, "end": 6004233}, {"filename": "/test/system/LICENSE.txt", "start": 6004233, "end": 6004924}, {"filename": "/test/system/menu.png", "start": 6004924, "end": 6168216}, {"filename": "/test/system/message.png", "start": 6168216, "end": 6169636}, {"filename": "/test/system/message_cursor.png", "start": 6169636, "end": 6173890}, {"filename": "/test/system/name.png", "start": 6173890, "end": 6174903}, {"filename": "/test/system/option.png", "start": 6174903, "end": 6187642}, {"filename": "/test/system/rain.png", "start": 6187642, "end": 6807091}, {"filename": "/test/system/sel_highlight.png", "start": 6807091, "end": 6824725}, {"filename": "/test/system/snow.png", "start": 6824725, "end": 6849192}, {"filename": "/test/voice/PRO000.wav", "start": 6849192, "end": 6926564, "audio": 1}, {"filename": "/test/voice/PRO001.wav", "start": 6926564, "end": 6969120, "audio": 1}], "remote_package_size": 6969120, "package_uuid": "a4f93a02-efe2-43e1-8601-fc782aaf557a"});
...
var ASM_CONSTS = {
  209264: function() {var gamedir = Module.ccall('get_emscripten_game_dir', 'string'); FS.mount(IDBFS, {}, gamedir + '/save'); FS.syncfs(true, function(err) { Module.ccall('reload_global_save'); });},  
 209441: function() {FS.syncfs(false, function(err) {});},  
 209477: function() {FS.syncfs(false, function(err) {});},  
 209513: function() {FS.syncfs(false, function(err) {});},  
 209549: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 209774: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 209911: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 210135: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 210628: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 210696: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 212348: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 212758: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 213363: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 ...
 217483: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 217576: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 217645: function() {return window.innerWidth;},  
 217675: function() {return window.innerHeight;}
};
...
/** @type {function(...*):?} */
var _get_emscripten_game_dir = Module["_get_emscripten_game_dir"] = createExportWrapper("get_emscripten_game_dir");

/** @type {function(...*):?} */
var _reload_global_save = Module["_reload_global_save"] = createExportWrapper("reload_global_save");
